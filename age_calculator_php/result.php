  ...
  <?php
    ...
    if($to_year > $birth_year){
        $f_y_r = $to_year - $birth_year;
    }
    else{
        $f_y_r = $to_year - $birth_year;
    }

    $dayar = array(0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
    ...
    // get minutes
    $get_mnts = $get_hour * 60;

    // get scnd
    $get_scnd = $get_mnts * 60;

    // get miliscnd
    $get_mlscnd = $get_scnd * 100;
...
<header style="background-color: #5373c8; position:sticky; top: 0; z-index: 1;">
    ...
    <h4 class="bg_blue rounded">Result</h4>
    <div class="py-2 px-4 mt-3 rounded" style="background: #f6f6f6;">
        <h4>Age:</h4>
        <p class="result_text"><?php echo $f_y_r; ?> Year, <?php echo $f_m_r; ?> Month, <?php echo $f_d_r; ?> Days</p>
        <p class="result_text">or <?php echo $get_month; ?>  months <?php echo $f_d_r; ?> days</p>
        <p class="result_text">or <?php echo round($get_week); ?> weeks</p>
        <p class="result_text">or <?php echo $get_days; ?> days</p>
        <p class="result_text">or <?php echo $get_hour; ?> hours</p>
        <p class="result_text">or <?php echo $get_mnts; ?> minutes</p>
        <p class="result_text">or <?php echo $get_scnd; ?> secounds</p>
        <p class="result_text">or <?php echo $get_mlscnd; ?> millisecounds</p>


        <div class="button_div" style="justify-content: end; margin: bottom 1rem;">
                   <a href="index.php" style="text-decoration:none; margin-bottom: 1rem;" ">
                    <button class="btn button_blue end_btn">Back</button>
                   </a>
    </div>
            ...
            <footer class=" d-flex mt-4 flex-wrap justify-content-between align-items-center py-3 border-top center_center  ">
